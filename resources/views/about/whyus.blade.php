@section('whyus')
    ...
    hidden md:flex lg-flex">
        ...
        flex justify-center items-center">
            ...
            gap-5">
                <p class="lg:text-3xl md:text-xl font-bold">
                    Why Choose Us?
                </p>

                <p class="lg:text-[18px] md:text-sm">
        ...
        justify-center items-center gap-10">
            ...
            justify-center items-center shadow-[0px_14px_40px_rgba(0,0,0,0.25)]">
                <span class="w-[80%] h-[80%] flex flex-col gap-5">
                    ...
                    <p class="lg:text-[20px] md:text-[15px] font-bold">24/7 Access & Support</p>
            ...
            justify-center items-center shadow-[0px_14px_40px_rgba(0,0,0,0.25)]">
                <span class="w-[80%] h-[80%] flex flex-col gap-5">
                    ...
                    <p class="lg:text-[20px] md:text-[15px] font-bold">Safe & Simple</p>
    ...
    <div class="w-[90%] h-290 flex items-center
    flex md:hidden lg-hidden flex-col gap-5">
        <span class="w-[100%] h-70 custombg2 flex flex-col text-[#FED077]
        justify-center items-center gap-5 rounded-lg">
            <p class="text-3xl font-bold text-center">
                Why Choose Us?
            </p>

            <p class="text-1xl text-center w-[90%]">
                We are Dedicated to ensuring that you have the best healthcare 
                services at an affordable price. We have a standard test for 
                everyone working with us.
            </p>
        ...
        <span class="w-full h-70 bg-[#E9FAFD] rounded-lg flex
        justify-center items-center shadow-[0px_14px_40px_rgba(0,0,0,0.25)]">
            <span class="w-[80%] h-[80%] flex flex-col gap-5">
                <img src="{{ asset('images/about/skilledexperts.png') }}"
                class="h-7 w-7" alt="">
        ...
        justify-center items-center shadow-[0px_14px_40px_rgba(0,0,0,0.25)]">
            <span class="w-[80%] h-[80%] flex flex-col gap-5">
                ...
                <p class="text-2xl font-bold">Safe & Simple</p>
