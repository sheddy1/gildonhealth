@section('about')
    <div class="relative w-full md:h-100 lg:h-120  mt-10  bg-blue-500 gap-5">
        ...
        <span class="w-full h-[90%] flex justify-center items-center bg-green-500 gap-7">
            <span class="absolute left-[1.5%] bg-yellow-500 w-[40%] h-[100%]">
            ...
            <span class="absolute right-[1.5%] bg-yellow-500 w-[55%] h-[100%]">
                asas
            </span>
