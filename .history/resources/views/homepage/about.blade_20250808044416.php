@section('about')
    <div class="w-full md:h-100 lg:h-120  mt-10 flex flex-col justify-center items-center bg-blue-500 gap-5">
        ...
        <span class="w-full h-[90%] flex justify-center items-center bg-green-500 gap-7">
            ...
            <span class="mr-[1.5%] bg-yellow-500 w-[63%] h-[100%] flex flex-col justify-center items-left gap-25">
                ...
                <p class="text-xl text-[#2A4652] text-left">
                    ...
                    Driven by innovation and compassion, Gildon Health is more than 
                    just a platform — it’s your partner in wellness. Our mission is 
                    to remove barriers to healthcare by combining technology, trusted 
                    professionals, and a supportive network in one place. With Gildon 
                    Health, you’re not just getting medical services; you’re joining a 
                    connected health community committed to helping you live healthier, 
                    happier, and longer.
                </p>
