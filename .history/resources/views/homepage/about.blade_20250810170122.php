@section('about')
    <div class="w-full md:h-100 lg:h-120 hidden lg:flex md:flex flex-col justify-center items-center bg-blue-500 gap-5">
    ...
    <div class="w-full h-300 flex lg:hidden md:hidden flex-col justify-center items-center bg-blue-500 gap-5">
        <span class="w-[90%] h-20% text-center flex bg-green-500 justify-center items-center flex-col">
        ...
        <span class=" rounded-lg bg-yellow-500 w-[90%] h-[50%] ">
            <video src="{{ asset('images/homepage/gildon.mp4') }}" class="rounded-lg h-full w-full object-cover flex" controls>
                Your browser does not support the video tag.
            </video>
        </span>

        <p class="text-2xl text-center w-[90%]  font-semibold text-[#2A4652] ">
            Comfortable Healthcare Services At Your Finger Tips
        </p>

        <p class="text-1xl text-[#2A4652] text-justify w-[90%]">
                    At Gildon Health, we believe that quality healthcare should be
                    simple, connected, and accessible to everyone no matter where
                    they are. Our platform brings together all essential healthcare
                    services into one easy to 'use' hub, ensuring that you can get the
