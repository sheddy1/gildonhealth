@section('benefits')
    ...
    <div class="relative w-full h-250 gap-2 mt-100 bg-blue-500 flex md:hidden lg:hidden">
        <span class="absolute w-full h-[30%]  md:hidden lg:hidden flex flex-col justify-top
        ...
        <span class="absolute bottom-0 right-[1.5%] w-full h-[47%] flex flex-col md:hidden lg:hidden
