        ...
        gap-3">
            ...
            <span class="w-full h-13 flex justify-center items-center">
                ...
                flex justify-center items-center gap-3">
                    ...
                    gap-0">
                        <p class="text-sm md:text-[10px] text-[#FED077] opacity-70">
                            Download From
                        </p>

                        <p class="text-1xl md:text-[15px] text-[#FED077] font-bold">
                            Play Store
                        </p>
                ...
                items-center gap-3">
                    ...
                    <span class="w-[50%] h-[65%] flex justify-center items-left flex-col
                    gap-0">
                        <p class="text-sm md:text-[7px] text-[#FED077] opacity-70">
                            Download From
                        </p>

                        <p class="text-1xl md:text-[12px] text-[#FED077] font-bold">
                            Apple Store
                        </p>
