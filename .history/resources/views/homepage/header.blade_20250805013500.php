@section('header')
    <div class="relative w-100% ">
        ...
        <span class="w-[70%] h-[100%] bg-blue-500 top-[50%] h-0 md:h-110 lg:h-120">
        ...
        <span class="absolute top-0 left-0 w-full h-76 md:h-0 lg:h-0 bg-[#2A4652]">
            asasas
        </span>
        ...
        <span >
            ...
            absolute top-[7%] right-[1.5%] h-[85%] w-140 z-1">
                <ul class="absolute top-0 right-0 flex flex-row justify-center items-left gap-20 text-xl">
