@section('benefits')
    <div class="relative w-full md:h-100 lg:h-120  mt-10">
    ...
    <div class="sec2 relative w-full h-300 gap-10 mt-100 bg-blue-500 flex flex-col justify-center
        items-center md:hidden lg:hidden">
        <span class="absolute top-0 w-full h-[35%]  md:hidden lg:hidden flex flex-col justify-top
        items-center gap-7 bg-red-500">
            <p class="text-3xl font-bold text-[#2A4652] text-center">
                Benefits of Joining Gildon Health
            </p>

            <p class="text-2xl font-semibold text-[#2A4652] text-center">
                Gildon health, has a whole lot of benefits, some of which are:
            </p>
        ...
        <span class="absolute bottom-0 right-[1.5%] w-full h-[50%] flex flex-col md:hidden lg:hidden
