@section('header')
    <div class="relative w-100% h-0 md:h-110 lg:h-120">
        ...
        <span class="w-[70%] h-[100%] bg-blue-500 top-[50%]">
            ...
            absolute top-[7%] left-[1.5%] h-[85%] w-120 bg-blue-500" >
        ...
        <span >
            ...
            absolute top-[7%] right-[1.5%] h-[85%] w-140 bg-blue-500 z-1">
                <ul class="absolute top-0 right-0 inline-block flex-row justify-center items-left gap-20 text-xl">
