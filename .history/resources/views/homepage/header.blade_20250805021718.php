@section('header')
    ...
    flex flex-col justify-center items-center gap-10 hidden
    custom-bg">
        ...
        w-[90%] h-7">
            ...
            class="ml-auto w-8 h-[100%] flex justify-end items-end" alt="">
        </span>

        <p class="text-xl text-[#FED077] text-center">An Online</p>

        <p class="text-3xl font-bold text-[#FED077] text-center">Healthcare System</p>

        <p class="text-xl text-[#FED077] text-center">Motto: Healthcare At Your Finger Tips</p>
