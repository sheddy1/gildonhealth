@section('benefits')
    ...
    <div class="w-full h-270 gap-10 flex flex-col justify-center
    items-center md:hidden lg:hidden bg-blue-500 gap-15">
        <span class="w-full h-[35%]  md:hidden lg:hidden flex flex-col justify-top
        items-center gap-5 ">
        ...
        <span class="right-[1.5%] w-full h-[63%] flex flex-col md:hidden lg:hidden
        justify-bottom items-center gap-10 bg-red-300">
                <img src="{{ asset('images/homepage/pic3.png') }}"
