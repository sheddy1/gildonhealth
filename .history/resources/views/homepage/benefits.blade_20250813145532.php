@section('benefits')
    ...
    <div class="w-full h-250 gap-10 flex flex-col justify-center
    items-center md:hidden lg:hidden bg-blue-500 gap-10">
        ...
        <span class="right-[1.5%] w-full h-[60%] flex flex-col md:hidden lg:hidden
