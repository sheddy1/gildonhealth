@section('about')
    ...
    <div class="w-full h-250 flex flex-col justify-center items-center bg-blue-500 gap-5
    lg:hidden md:hidden">
        <span class="w-[90%] ml-[1.5%] mr-[1.5%] h-20% text-center flex
        bg-green-500 justify-center items-center flex-col gap-5">
            ...
            <p class="lg:text-2xl md:text-sm font-semibold text-[#2A4652] ">
                Comfortable Healthcare Services At Your Finger Tips
            </p>

            <p class="lg:text-1xl md:text-xs text-[#2A4652] text-left">
                    At Gildon Health, we believe that quality healthcare should be
                    simple, connected, and accessible to everyone no matter where
                    they are. Our platform brings together all essential healthcare
                    services into one easy to 'use' hub, ensuring that you can get the
