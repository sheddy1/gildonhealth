@section('about')
    ...
    lg:hidden md:hidden">
        <span class="w-[90%] ml-[1.5%] mr-[1.5%] h-20% text-center flex bg-green-500 justify-center items-center flex-col">
            <p class="text-3xl font-bold text-[#2A4652]">
                About Gildon Health
            </p>
        ...
        <span class="w-full h-[77%] flex flex-col justify-center items-center bg-green-500 gap-7">
            <span class="ml-[1.5%] rounded-lg bg-yellow-500 w-[40%] h-[100%] ">
                <video src="{{ asset('images/homepage/gildon.mp4') }}" class="rounded-lg h-full w-full object-cover flex" controls>
                Your browser does not support the video tag.
                </video>
