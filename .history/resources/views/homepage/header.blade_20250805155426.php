@section('header')
    ...
    custom-bg">
        ...
        w-[90%] h-7 lg:hidden md:hidden">
            ...
            class="ml-auto w-8 h-[100%] flex justify-end items-end" alt="Logo">

            <span class="absolute right-[5%] top-16 bg-[#E9FAFD] w-[55%] h-[45%]
            rounded-tl-lg rounded-bl-lg rounded-br-lg flex flex-col justify-center items-center">
                <span class="h-6 w-full bg-blue-500 flex justify-center items-center gap-3">
                    <img src="{{ asset('images/homepage/home.png') }}"
                    class="w-8 h-[100%] flex justify-end items-end" alt="Logo">

                    <p class="text-[#2A4652] text-1xl">Home</p>
                </span>
            </span>
