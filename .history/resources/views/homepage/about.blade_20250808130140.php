@section('about')
    <div class="w-full md:h-100 lg:h-120  mt-10 flex flex-col justify-center items-center bg-blue-500 gap-5">
        <span class="w-full h-20% flex bg-brown-500 justify-center text-center items-center flex-col">
            <p class="text-3xl text-center font-bold text-[#2A4652]">
                About Gildon Health
            </p>

            <p class="text-xl text-center text-[#2A4652]">
                Gildon Health is dedicated to providing affordable and accessible healthcare solutions to individuals and families.
            </p>
        </span>
        
        <span class="w-full h-[80%] flex justify-center items-center bg-green-500 gap-7">
            ...
            <span class="mr-[1.5%] bg-yellow-500 w-[63%] h-[100%] flex flex-col justify-center items-left gap-11">
                <p class="text-2xl font-semibold text-[#2A4652] ">
                    Comfortable Healthcare Services At Your Finger Tips
                </p>

                <p class="text-1xl text-[#2A4652] text-left">
