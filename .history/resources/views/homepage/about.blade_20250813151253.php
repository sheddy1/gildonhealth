@section('about')
    <div class="w-full md:h-100 lg:h-120 hidden lg:flex md:flex flex-col justify-center items-center gap-5">
        ...
        <span class="w-full h-[77%] flex justify-center items-center  gap-7">
            ...
            <span class="mr-[1.5%] w-[63%] h-[100%] flex flex-col justify-center items-left gap-15 md:gap-3">
