@section('contact')
    ...
    justify-center items-center gap-[25%]">
        <span class="w-[35%] h-full rounded-[15px] flex flex-col justify-center items-left">
            <span class="w-full h-[5%] bg-[#FED077]  rounded-tr-[10px]">
            </span>

            <span class="w-full h-[95%] bg-[#2A4652] flex justify-center items-center
            flex-col gap-6 rounded-bl-[10px]
            rounded-br-[10px]">
    ...
    <div class="w-full h-200 flex md:hidden lg:hidden
    justify-center items-center gap-5 flex-col">
        <p class="text-1xl font-[600]">Contact Us</p>
            ...
            <span class="w-[90%] h-10 flex justify-center items-center gap-3">
                <img src="{{ asset('images/homepage/instagram.png') }}"
                class="w-1/6 h-full cursor-pointer" alt="">
            ...
            <span class="w-[90%] h-full rounded-[15px] flex flex-col justify-center items-left">
                <span class="w-full h-[5%] bg-[#FED077] rounded-tl-[10px] rounded-tr-[10px]">
                </span>

                <span class="w-full h-[95%] bg-[#2A4652] flex justify-center items-center
                flex-col gap-7 rounder-bl-[10px]">
                    <span class="w-[90%] h-13 flex justify-center items-left
                        gap-0 flex-col">
                            <p class="text-[#FED077] text-1xl">First Name*</p>
