@section('contact')
    ...
    justify-center items-center gap-[25%]">
        <span class="w-[35%] h-full bg-blue-400 rounded-[15px] flex flex-col justify-center items-left">
            ...
            flex-col gap-6">
                <span class="w-[90%] h-13 bg-blue-400 flex justify-center items-center
                gap-[4%]">
                    <span class="w-[48%] h-full flex justify-center items-left bg-green-400
                    gap-0 flex-col">
                        <p class="text-[#FED077] text-1xl">Name</p>

                        <input type="text" class="w-full h-15 rounded-[10px] border-[2px] border-[#FED077]
                        text-[#FED077]  placeholder="Enter your name">
                    </span>

                    <span class="w-[48%] h-full flex justify-center items-center bg-green-400
                    gap-3 flex-col">
