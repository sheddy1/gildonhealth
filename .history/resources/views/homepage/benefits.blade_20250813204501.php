@section('benefits')
    ...
    <div class="w-full h-320 gap-10 flex flex-col justify-center
    items-center md:hidden lg:hidden gap-15 bg-green-500">
        <span class="w-[90%] h-[35%]  md:hidden lg:hidden flex flex-col justify-top
        items-center gap-5 ">
        ...
        <span class="right-[1.5%] w-[90%] h-[64%] flex flex-col md:hidden lg:hidden
