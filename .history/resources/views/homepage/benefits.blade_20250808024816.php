@section('benefits')
    ...
    <div class="relative w-full h-250 gap-10 mt-100 bg-blue-500 flex flex-col justify-center
        items-center md:hidden lg:hidden">
        <span class=" w-full h-[40%]  md:hidden lg:hidden flex flex-col justify-top
