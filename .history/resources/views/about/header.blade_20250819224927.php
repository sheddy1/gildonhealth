@section('header')
    ...
    flex-col">
        <span class="text-[#FED077] absolute top-[30px] w-[97%] h-10 bg-blue-400 flex justify-center items-center">
        ...
        <span class="text-[#FED077] w-[97%] flex justify-center items-center flex-col">
