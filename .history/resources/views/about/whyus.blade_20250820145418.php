@section('whyus')
    ...
    hidden md:flex lg-flex">
        ...
        flex justify-center items-center">
            <span class="absolute left-[5%] lg:w-60 md:w-60 h-60 flex flex-col text-[#FED077]
            gap-5">
        ...
        justify-center items-center gap-10">
            ...
            justify-center items-center">
                <span class="w-[80%] h-[80%] flex flex-col gap-5">
                    ...
                    <p class="text-xl font-bold">Skilled Experts</p>
            ...
            justify-center items-center">
                <span class="w-[80%] h-[80%] flex flex-col gap-5">
                    ...
                    <p class="text-xl font-bold">24/7 Access & Support</p>
            ...
            justify-center items-center">
                <span class="w-[80%] h-[80%] flex flex-col gap-5">
                    ...
                    <p class="lg:text-xl md:text-1xl font-bold">Safe & Simple</p>
