@section('header')
    ...
    flex-col">
        <span class="w-[97%] h-10 flex justify-center items-center gap-5
        absolute top-[30px] text-[#FED077]">
            ...
            <span class="flex justify-center items-center gap-14 text-xl">
                ...
                <p><a class="font-bold text-decoration-underline" href="{{ route('about') }}">About</a></p>
    ...
    flex-col">
        ...
        <span class="text-[#FED077] w-[90%] flex justify-center items-center flex-col gap-5">
            <p class="font-bold text-3xl">About Us</p>
