@section('whychooseus')
    <div class="h-110 w-[97%] bg-blue-500 lg:flex md:flex
    ...
    ">
        ...
        <span class="w-[48%] h-full flex justify-center items-center bg-blue-400
        flex-col gap-[4%]">
            <span class="w-full h-[48%] bg-blue-300 flex justify-center 
            items-center gap-[4%]">
                <span class="w-[48%] h-full bg-[#2A4652] flex justify-center 
                items-center rounded-lg flex-col text-[#E9FAFD]">
                    <img src="{{ asset('images/careers/earn2.png') }}"
                    class="w-13 h-13" alt="">

                    <p class="w-[90%] text-2xl font-bold">
                        Earn More Stress Less
                    </p>

                    <p class="text-1xl w-[90%]">
                        Enjoy a steady income of ₦400K+ monthly with 
                        flexible hours and minimal overhead.
                    </p>
                </span>

                <span class="w-[48%] h-full bg-blue-200 flex justify-center 
                items-center rounded-lg">

                </span>
            </span>

            <span class="w-full h-[48%] bg-blue-300">
