@section('header')
    ...
    <div class="mt-6 w-[90%] h-10 flex lg:hidden md:hidden flex-col justify-center
    items-center gap-5 text-[#2A4652]">
        ...
        w-full h-7 lg:hidden md:hidden " >
            ...
            <span class="dropdown absolute right-[1.5%] top-20 bg-[#E9FAFD] w-[55%] h-50
            rounded-tl-lg rounded-bl-lg rounded-br-lg  flex-col justify-center items-center
            gap-6 hidden shadow-[0px_14px_40px_rgba(0,0,0,0.25)]">
