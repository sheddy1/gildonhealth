@section('whychooseus')
    ...
    <div class="h-380 w-[90%] lg:hidden md:hidden bg-blue-500 flex-col
    ...
    ">
        ...
        <span class="w-full h-70 bg-[#E9FAFD] flex justify-center 
        items-center rounded-lg flex-col text-[#2A4652] gap-8
        shadow-[0px_14px_40px_rgba(0,0,0,0.25)]">
            <img src="{{ asset('images/careers/teams.png') }}"
            class="w-11 h-11" alt="">
