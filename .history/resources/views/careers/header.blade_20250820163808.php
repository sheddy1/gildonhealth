@section('header')
    <div class="absolute top-[30px] w-[97%] h-10 hidden lg:flex md:flex flex-col justify-center bg-blue-500
    items-center gap-5">
        <span class="text-[#FED077]  w-[97%] h-10 flex justify-center items-center">
